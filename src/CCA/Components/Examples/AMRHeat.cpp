                                          ...
                                          SchedulerP& sched)
{
  ...
  task->requires(Task::WhichDW::NewDW, d_lb->temperature_nc, Ghost::AroundNodes, 1);
                                    ...
                                    SchedulerP& sched)
{
  if(getLevel(patches)->hasCoarserLevel()){
    ...
    task->requires(Task::WhichDW::NewDW, d_lb->temperature_nc, 0, Task::PatchDomainSpec::CoarseLevel,
                   0, Task::MaterialDomainSpec::NormalDomain, Ghost::AroundNodes, 1);
