...
ManifoldRxn::sched_computeSource( const LevelP& level, SchedulerP& sched, int timeSubStep )
{
  ...
  tsk->requires( Task::WhichDW::NewDW, _old_manifold_label, Ghost::AroundCells, 1 );
  ...
  tsk->requires( Task::WhichDW::NewDW, _manifold_label, Ghost::None, 0 );
  tsk->requires(Task::WhichDW::NewDW, VarLabel::find("uVelocitySPBC"), Ghost::AroundCells, 1);
  tsk->requires(Task::WhichDW::NewDW, VarLabel::find("vVelocitySPBC"), Ghost::AroundCells, 1);
  tsk->requires(Task::WhichDW::NewDW, VarLabel::find("wVelocitySPBC"), Ghost::AroundCells, 1);
  tsk->requires(Task::WhichDW::OldDW, VarLabel::find("areaFraction"), Ghost::AroundCells, 2);
  tsk->requires(Task::WhichDW::NewDW, VarLabel::find("density_old"), Ghost::AroundCells, 1);
  tsk->requires(Task::WhichDW::NewDW, VarLabel::find("density"), Ghost::None, 0);
  tsk->requires(Task::WhichDW::NewDW, VarLabel::find("turb_viscosity"), Ghost::AroundCells, 1);
  tsk->requires(Task::WhichDW::OldDW, _field_labels->d_delTLabel);
