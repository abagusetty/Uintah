...
#ifdef HAVE_SYCL
                                     , &UnweightVariable<T>::compute_bcs<KOKKOS_SYCL_TAG>    // Task supports Kokkos::Sycl builds
...
#ifdef HAVE_SYCL
                                     , &UnweightVariable<T>::initialize<KOKKOS_SYCL_TAG>    // Task supports Kokkos::Sycl builds
#elif defined(HAVE_CUDA)
...
#ifdef HAVE_SYCL
                                     , &UnweightVariable<T>::eval<KOKKOS_SYCL_TAG>    // Task supports Kokkos::Sycl builds
#elif defined(HAVE_CUDA)
