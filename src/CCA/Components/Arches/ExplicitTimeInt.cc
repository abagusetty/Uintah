                                       ...
                                       int rkstep )
{
  ...
  for ( std::vector<std::string>::iterator iter = phi.begin(); iter != phi.end(); iter++ ){ 
    ...
    tsk->modifies( lab );
    tsk->requires( Task::WhichDW::OldDW, lab, ghost_type, n_extra );
  } 
  // rhs
  for ( std::vector<std::string>::iterator iter = rhs.begin(); iter != rhs.end(); iter++ ){ 
    ...
    tsk->requires( Task::WhichDW::NewDW, lab, ghost_type, n_extra ); 
                                      ...
                                      int rkstep)
{
  ...
  for ( std::vector<std::string>::iterator iter = phi.begin(); iter != phi.end(); iter++ ){ 
    ...
    tsk->requires( Task::WhichDW::OldDW, lab, ghost_type, extra_cells ); 
    tsk->modifies( lab ); 
