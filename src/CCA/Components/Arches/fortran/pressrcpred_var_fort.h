...
extern "C" void pressrcpred_var_(int* idxLo,
                                 int* idxHi,
                                  ...
                                  Uintah::OffsetArray1<double> & stb )
{
  ...
  Uintah::IntVector divU_low = divU.offset();
  Uintah::IntVector divU_high = divU.size() + divU_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector uhat_low = uhat.offset();
  Uintah::IntVector uhat_high = uhat.size() + uhat_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector vhat_low = vhat.offset();
  Uintah::IntVector vhat_high = vhat.size() + vhat_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector what_low = what.offset();
  Uintah::IntVector what_high = what.size() + what_low - Uintah::IntVector(1, 1, 1);
  ...
  pressrcpred_var_( idxLo.get_pointer(),
                    idxHi.get_pointer(),
