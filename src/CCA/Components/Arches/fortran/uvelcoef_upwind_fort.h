...
#ifndef fspec_uvelcoef_upwind
#define fspec_uvelcoef_upwind

#ifdef __cplusplus

extern "C" void uvelcoef_upwind_(int* uu_low_x, int* uu_low_y, int* uu_low_z, int* uu_high_x, int* uu_high_y, int* uu_high_z, double* uu_ptr,
...
static void fort_uvelcoef_upwind( Uintah::constSFCXVariable<double> & uu,
                                  ...
                                  Uintah::IntVector & idxHiU )
{
  ...
  uvelcoef_upwind_( &uu_low_x, &uu_low_y, &uu_low_z, &uu_high_x, &uu_high_y, &uu_high_z, const_cast<double*>(uu.getPointer()),
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine uvelcoef_upwind(uu_low_x, uu_low_y, uu_low_z, 
     ...
     & eps_high_y, eps_high_z, eps, deltat, grav, dx, dy, dz, idxLoU, 
     & idxHiU)
