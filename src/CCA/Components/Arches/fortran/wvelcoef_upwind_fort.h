...
#ifndef fspec_wvelcoef_upwind
#define fspec_wvelcoef_upwind

#ifdef __cplusplus

extern "C" void wvelcoef_upwind_(int* ww_low_x, int* ww_low_y, int* ww_low_z, int* ww_high_x, int* ww_high_y, int* ww_high_z, double* ww_ptr,
...
static void fort_wvelcoef_upwind( Uintah::constSFCZVariable<double> & ww,
                                  ...
                                  Uintah::IntVector & idxHiW )
{
  ...
  wvelcoef_upwind_( &ww_low_x, &ww_low_y, &ww_low_z, &ww_high_x, &ww_high_y, &ww_high_z, const_cast<double*>(ww.getPointer()),
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine wvelcoef_upwind(ww_low_x, ww_low_y, ww_low_z, 
