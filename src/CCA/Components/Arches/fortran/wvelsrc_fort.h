...
extern "C" void wvelsrc_(int* idxLoW,
                         int* idxHiW,
                          ...
                          Uintah::OffsetArray1<int> & kbsdw )
{
  ...
  Uintah::IntVector old_ww_low = old_ww.offset();
  Uintah::IntVector old_ww_high = old_ww.size() + old_ww_low - Uintah::IntVector(1, 1, 1);
