...
#ifndef fspec_vvelcoef_mixed
#define fspec_vvelcoef_mixed

#ifdef __cplusplus

extern "C" void vvelcoef_mixed_(int* vv_low_x, int* vv_low_y, int* vv_low_z, int* vv_high_x, int* vv_high_y, int* vv_high_z, double* vv_ptr,
...
static void fort_vvelcoef_mixed( Uintah::constSFCYVariable<double> & vv,
                                 ...
                                 Uintah::IntVector & idxHiV )
{
  ...
  vvelcoef_mixed_( &vv_low_x, &vv_low_y, &vv_low_z, &vv_high_x, &vv_high_y, &vv_high_z, const_cast<double*>(vv.getPointer()),
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine vvelcoef_mixed(vv_low_x, vv_low_y, vv_low_z, vv_high_x
     & , vv_high_y, vv_high_z, vv, celltype_low_x, celltype_low_y, 
