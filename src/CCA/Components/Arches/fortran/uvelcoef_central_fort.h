...
#ifndef fspec_uvelcoef_central
#define fspec_uvelcoef_central

#ifdef __cplusplus

extern "C" void uvelcoef_central_(int* uu_low_x, int* uu_low_y, int* uu_low_z, int* uu_high_x, int* uu_high_y, int* uu_high_z, double* uu_ptr,
...
static void fort_uvelcoef_central( Uintah::constSFCXVariable<double> & uu,
                                   ...
                                   Uintah::IntVector & idxHiU )
{
  ...
  uvelcoef_central_( &uu_low_x, &uu_low_y, &uu_low_z, &uu_high_x, &uu_high_y, &uu_high_z, const_cast<double*>(uu.getPointer()),
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine uvelcoef_central(uu_low_x, uu_low_y, uu_low_z, 
     & uu_high_x, uu_high_y, uu_high_z, uu, cesav_low_x, cesav_low_y, 
     ...
     & SU_high_z, SU, old_den_low_x, old_den_low_y, old_den_low_z, 
     & old_den_high_x, old_den_high_y, old_den_high_z, old_den, 
     & old_UU_low_x, old_UU_low_y, old_UU_low_z, old_UU_high_x, 
     & old_UU_high_y, old_UU_high_z, old_UU, eps_low_x, eps_low_y, 
     & eps_low_z, eps_high_x, eps_high_y, eps_high_z, eps, deltat, grav
     & , dx, dy, dz, idxLoU, idxHiU)
