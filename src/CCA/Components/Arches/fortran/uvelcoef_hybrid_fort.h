                                  ...
                                  Uintah::IntVector & idxHiU )
{
  ...
  Uintah::IntVector celltype_low = celltype.offset();
  Uintah::IntVector celltype_high = celltype.size() + celltype_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector cvsx_low = cvsx.offset();
  Uintah::IntVector cvsx_high = cvsx.size() + cvsx_low - Uintah::IntVector(1, 1, 1);
