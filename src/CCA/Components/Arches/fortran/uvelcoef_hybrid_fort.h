...
#ifndef fspec_uvelcoef_hybrid
#define fspec_uvelcoef_hybrid

#ifdef __cplusplus

extern "C" void uvelcoef_hybrid_(int* uu_low_x, int* uu_low_y, int* uu_low_z, int* uu_high_x, int* uu_high_y, int* uu_high_z, double* uu_ptr,
                                 int* celltype_low_x, int* celltype_low_y, int* celltype_low_z, int* celltype_high_x, int* celltype_high_y, int* celltype_high_z, int* celltype_ptr,
                                 ...
                                 int* cvsx_low_x, int* cvsx_low_y, int* cvsx_low_z, int* cvsx_high_x, int* cvsx_high_y, int* cvsx_high_z, double* cvsx_ptr,
                                 double* deltat,
                                 double* grav,
                                 double* dx,
                                 double* dy,
...
static void fort_uvelcoef_hybrid( Uintah::constSFCXVariable<double> & uu,
                                  Uintah::constCCVariable<int> & celltype,
                                  ...
                                  Uintah::SFCXVariable<double> & cvsx,
                                  double & deltat,
                                  double & grav,
                                  double & dx,
                                  double & dy,
                                  ...
                                  Uintah::IntVector & idxHiU )
{
  ...
  Uintah::IntVector celltype_low = celltype.getWindow()->getOffset();
  Uintah::IntVector celltype_high = celltype.getWindow()->getData()->size() + celltype_low - Uintah::IntVector(1, 1, 1);
  int celltype_low_x = celltype_low.x();
  int celltype_high_x = celltype_high.x();
  int celltype_low_y = celltype_low.y();
  int celltype_high_y = celltype_high.y();
  int celltype_low_z = celltype_low.z();
  int celltype_high_z = celltype_high.z();
  ...
  Uintah::IntVector cvsx_low = cvsx.getWindow()->getOffset();
  Uintah::IntVector cvsx_high = cvsx.getWindow()->getData()->size() + cvsx_low - Uintah::IntVector(1, 1, 1);
  int cvsx_low_x = cvsx_low.x();
  int cvsx_high_x = cvsx_high.x();
  int cvsx_low_y = cvsx_low.y();
  int cvsx_high_y = cvsx_high.y();
  int cvsx_low_z = cvsx_low.z();
  int cvsx_high_z = cvsx_high.z();
  uvelcoef_hybrid_( &uu_low_x, &uu_low_y, &uu_low_z, &uu_high_x, &uu_high_y, &uu_high_z, const_cast<double*>(uu.getPointer()),
                    &celltype_low_x, &celltype_low_y, &celltype_low_z, &celltype_high_x, &celltype_high_y, &celltype_high_z, const_cast<int*>(celltype.getPointer()),
                    ...
                    &cvsx_low_x, &cvsx_low_y, &cvsx_low_z, &cvsx_high_x, &cvsx_high_y, &cvsx_high_z, cvsx.getPointer(),
                    &deltat,
                    &grav,
                    &dx,
                    &dy,
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine uvelcoef_hybrid(uu_low_x, uu_low_y, uu_low_z, 
     & uu_high_x, uu_high_y, uu_high_z, uu, celltype_low_x, 
     & celltype_low_y, celltype_low_z, celltype_high_x, celltype_high_y
     & , celltype_high_z, celltype, cesav_low_x, cesav_low_y, 
     ...
     & ab_high_x, ab_high_y, ab_high_z, ab, vv_low_x, vv_low_y, 
     & vv_low_z, vv_high_x, vv_high_y, vv_high_z, vv, ww_low_x, 
     & ww_low_y, ww_low_z, ww_high_x, ww_high_y, ww_high_z, ww, 
     ...
     & eps_high_y, eps_high_z, eps, cvsx_low_x, cvsx_low_y, cvsx_low_z,
     &  cvsx_high_x, cvsx_high_y, cvsx_high_z, cvsx, deltat, grav, dx, 
     & dy, dz, WALL, INTR, Relimit, idxLoU, idxHiU)
     ...
     & uu_low_z:uu_high_z)
      integer celltype_low_x, celltype_low_y, celltype_low_z, 
     & celltype_high_x, celltype_high_y, celltype_high_z
      integer celltype(celltype_low_x:celltype_high_x, celltype_low_y:
     & celltype_high_y, celltype_low_z:celltype_high_z)
     ...
     & eps_low_z:eps_high_z)
      integer cvsx_low_x, cvsx_low_y, cvsx_low_z, cvsx_high_x, 
     & cvsx_high_y, cvsx_high_z
      double precision cvsx(cvsx_low_x:cvsx_high_x, cvsx_low_y:
     & cvsx_high_y, cvsx_low_z:cvsx_high_z)
      ...
      integer WALL
      integer INTR
      double precision Relimit
      integer idxLoU(3)
      integer idxHiU(3)
#endif /* __cplusplus */

#endif /* fspec_uvelcoef_hybrid */
