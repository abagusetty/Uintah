...
#ifndef fspec_vvelcoef_central
#define fspec_vvelcoef_central

#ifdef __cplusplus

extern "C" void vvelcoef_central_(int* vv_low_x, int* vv_low_y, int* vv_low_z, int* vv_high_x, int* vv_high_y, int* vv_high_z, double* vv_ptr,
...
static void fort_vvelcoef_central( Uintah::constSFCYVariable<double> & vv,
                                   ...
                                   Uintah::IntVector & idxHiV )
{
  ...
  vvelcoef_central_( &vv_low_x, &vv_low_y, &vv_low_z, &vv_high_x, &vv_high_y, &vv_high_z, const_cast<double*>(vv.getPointer()),
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine vvelcoef_central(vv_low_x, vv_low_y, vv_low_z, 
     & vv_high_x, vv_high_y, vv_high_z, vv, cesav_low_x, cesav_low_y, 
     ...
     & eps_high_y, eps_high_z, eps, deltat, grav, dx, dy, dz, idxLoV, 
     & idxHiV)
