...
#ifndef fspec_vvelcoef_upwind
#define fspec_vvelcoef_upwind

#ifdef __cplusplus

extern "C" void vvelcoef_upwind_(int* vv_low_x, int* vv_low_y, int* vv_low_z, int* vv_high_x, int* vv_high_y, int* vv_high_z, double* vv_ptr,
...
static void fort_vvelcoef_upwind( Uintah::constSFCYVariable<double> & vv,
                                  ...
                                  Uintah::IntVector & idxHiV )
{
  ...
  vvelcoef_upwind_( &vv_low_x, &vv_low_y, &vv_low_z, &vv_high_x, &vv_high_y, &vv_high_z, const_cast<double*>(vv.getPointer()),
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine vvelcoef_upwind(vv_low_x, vv_low_y, vv_low_z, 
