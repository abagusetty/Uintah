...
#ifndef fspec_wvelcoef_hybrid
#define fspec_wvelcoef_hybrid

#ifdef __cplusplus

extern "C" void wvelcoef_hybrid_(int* ww_low_x, int* ww_low_y, int* ww_low_z, int* ww_high_x, int* ww_high_y, int* ww_high_z, double* ww_ptr,
                                 ...
                                 int* cvsz_low_x, int* cvsz_low_y, int* cvsz_low_z, int* cvsz_high_x, int* cvsz_high_y, int* cvsz_high_z, double* cvsz_ptr,
                                 double* deltat,
                                 double* grav,
                                 double* dx,
                                 double* dy,
...
static void fort_wvelcoef_hybrid( Uintah::constSFCZVariable<double> & ww,
                                  ...
                                  Uintah::SFCZVariable<double> & cvsz,
                                  double & deltat,
                                  double & grav,
                                  double & dx,
                                  double & dy,
                                  ...
                                  Uintah::IntVector & idxHiW )
{
  ...
  Uintah::IntVector cvsz_low = cvsz.getWindow()->getOffset();
  Uintah::IntVector cvsz_high = cvsz.getWindow()->getData()->size() + cvsz_low - Uintah::IntVector(1, 1, 1);
  int cvsz_low_x = cvsz_low.x();
  int cvsz_high_x = cvsz_high.x();
  int cvsz_low_y = cvsz_low.y();
  int cvsz_high_y = cvsz_high.y();
  int cvsz_low_z = cvsz_low.z();
  int cvsz_high_z = cvsz_high.z();
  wvelcoef_hybrid_( &ww_low_x, &ww_low_y, &ww_low_z, &ww_high_x, &ww_high_y, &ww_high_z, const_cast<double*>(ww.getPointer()),
                    ...
                    &cvsz_low_x, &cvsz_low_y, &cvsz_low_z, &cvsz_high_x, &cvsz_high_y, &cvsz_high_z, cvsz.getPointer(),
                    &deltat,
                    &grav,
                    &dx,
                    &dy,
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine wvelcoef_hybrid(ww_low_x, ww_low_y, ww_low_z, 
     & ww_high_x, ww_high_y, ww_high_z, ww, celltype_low_x, 
     ...
     & eps_high_y, eps_high_z, eps, cvsz_low_x, cvsz_low_y, cvsz_low_z,
     &  cvsz_high_x, cvsz_high_y, cvsz_high_z, cvsz, deltat, grav, dx, 
     & dy, dz, WALL, INTR, Relimit, idxLoW, idxHiW)
     ...
     & eps_low_z:eps_high_z)
      integer cvsz_low_x, cvsz_low_y, cvsz_low_z, cvsz_high_x, 
     & cvsz_high_y, cvsz_high_z
      double precision cvsz(cvsz_low_x:cvsz_high_x, cvsz_low_y:
     & cvsz_high_y, cvsz_low_z:cvsz_high_z)
