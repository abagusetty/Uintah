...
extern "C" void wvelcoef_central_(int* ww_low_x, int* ww_low_y, int* ww_low_z, int* ww_high_x, int* ww_high_y, int* ww_high_z, double* ww_ptr,
                                   ...
                                   Uintah::IntVector & idxHiW )
{
  ...
  wvelcoef_central_( &ww_low_x, &ww_low_y, &ww_low_z, &ww_high_x, &ww_high_y, &ww_high_z, const_cast<double*>(ww.getPointer()),
