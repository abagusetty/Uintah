...
#ifndef fspec_wvelcoef_mixed
#define fspec_wvelcoef_mixed

#ifdef __cplusplus

extern "C" void wvelcoef_mixed_(int* ww_low_x, int* ww_low_y, int* ww_low_z, int* ww_high_x, int* ww_high_y, int* ww_high_z, double* ww_ptr,
...
static void fort_wvelcoef_mixed( Uintah::constSFCZVariable<double> & ww,
                                 ...
                                 Uintah::IntVector & idxHiW )
{
  ...
  wvelcoef_mixed_( &ww_low_x, &ww_low_y, &ww_low_z, &ww_high_x, &ww_high_y, &ww_high_z, const_cast<double*>(ww.getPointer()),
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine wvelcoef_mixed(ww_low_x, ww_low_y, ww_low_z, ww_high_x
     & , ww_high_y, ww_high_z, ww, celltype_low_x, celltype_low_y, 
     & celltype_low_z, celltype_high_x, celltype_high_y, 
     & celltype_high_z, celltype, cesav_low_x, cesav_low_y, cesav_low_z
     ...
     & eps_high_z, eps, deltat, grav, dx, dy, dz, WALL, INTR, Relimit, 
     & idxLoW, idxHiW)
