...
extern "C" void smagmodel_(int* uu_low_x, int* uu_low_y, int* uu_low_z, int* uu_high_x, int* uu_high_y, int* uu_high_z, double* uu_ptr,
                            ...
                            double & filterl )
{
  ...
  Uintah::IntVector ucc_low = ucc.offset();
  Uintah::IntVector ucc_high = ucc.size() + ucc_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector vcc_low = vcc.offset();
  Uintah::IntVector vcc_high = vcc.size() + vcc_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector wcc_low = wcc.offset();
  Uintah::IntVector wcc_high = wcc.size() + wcc_low - Uintah::IntVector(1, 1, 1);
  ...
  smagmodel_( &uu_low_x, &uu_low_y, &uu_low_z, &uu_high_x, &uu_high_y, &uu_high_z, const_cast<double*>(uu.getPointer()),
