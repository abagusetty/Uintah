...
extern "C" void vvelsrc_(int* idxLoV,
                         int* idxHiV,
                          ...
                          Uintah::OffsetArray1<int> & jssdv )
{
  ...
  Uintah::IntVector old_vv_low = old_vv.offset();
  Uintah::IntVector old_vv_high = old_vv.size() + old_vv_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector sp_low = sp.offset();
  Uintah::IntVector sp_high = sp.size() + sp_low - Uintah::IntVector(1, 1, 1);
