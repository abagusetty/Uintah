...
extern "C" void rdombmcalc_(int* idxlo,
                            int* idxhi,
                             ...
                             double & srcsum )
{
  ...
  Uintah::IntVector volume_low = volume.offset();
  Uintah::IntVector volume_high = volume.size() + volume_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector src_low = src.offset();
  Uintah::IntVector src_high = src.size() + src_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector qfluxe_low = qfluxe.offset();
  Uintah::IntVector qfluxe_high = qfluxe.size() + qfluxe_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector qfluxw_low = qfluxw.offset();
  Uintah::IntVector qfluxw_high = qfluxw.size() + qfluxw_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector qfluxn_low = qfluxn.offset();
  Uintah::IntVector qfluxn_high = qfluxn.size() + qfluxn_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector qfluxs_low = qfluxs.offset();
  Uintah::IntVector qfluxs_high = qfluxs.size() + qfluxs_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector qfluxt_low = qfluxt.offset();
  Uintah::IntVector qfluxt_high = qfluxt.size() + qfluxt_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector qfluxb_low = qfluxb.offset();
  Uintah::IntVector qfluxb_high = qfluxb.size() + qfluxb_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector volq_low = volq.offset();
  Uintah::IntVector volq_high = volq.size() + volq_low - Uintah::IntVector(1, 1, 1);
