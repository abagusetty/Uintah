...
extern "C" void radcoef_(int* idxlo,
                         int* idxhi,
                          ...
                          bool & lradcal )
{
  ...
  Uintah::IntVector abskp_low = abskp.offset();
  Uintah::IntVector abskp_high = abskp.size() + abskp_low - Uintah::IntVector(1, 1, 1);
