                            ...
                            Uintah::CCVariable<double> & scatSrc )
{
  ...
  Uintah::IntVector esrct_low = esrct.offset();
  Uintah::IntVector esrct_high = esrct.size() + esrct_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector abskt_low = abskt.offset();
  Uintah::IntVector abskt_high = abskt.size() + abskt_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector IncidentFluxE_low = IncidentFluxE.offset();
  Uintah::IntVector IncidentFluxE_high = IncidentFluxE.size() + IncidentFluxE_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector IncidentFluxW_low = IncidentFluxW.offset();
  Uintah::IntVector IncidentFluxW_high = IncidentFluxW.size() + IncidentFluxW_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector IncidentFluxN_low = IncidentFluxN.offset();
  Uintah::IntVector IncidentFluxN_high = IncidentFluxN.size() + IncidentFluxN_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector IncidentFluxS_low = IncidentFluxS.offset();
  Uintah::IntVector IncidentFluxS_high = IncidentFluxS.size() + IncidentFluxS_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector IncidentFluxT_low = IncidentFluxT.offset();
  Uintah::IntVector IncidentFluxT_high = IncidentFluxT.size() + IncidentFluxT_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector IncidentFluxB_low = IncidentFluxB.offset();
  Uintah::IntVector IncidentFluxB_high = IncidentFluxB.size() + IncidentFluxB_low - Uintah::IntVector(1, 1, 1);
  ...
  Uintah::IntVector scatSrc_low = scatSrc.offset();
  Uintah::IntVector scatSrc_high = scatSrc.size() + scatSrc_low - Uintah::IntVector(1, 1, 1);
