...
extern "C" void hottel_(int* idxlo,
                        int* idxhi,
                         ...
                         double & pressure )
{
  ...
  Uintah::IntVector volfrac_low = volfrac.offset();
  Uintah::IntVector volfrac_high = volfrac.size() + volfrac_low - Uintah::IntVector(1, 1, 1);
